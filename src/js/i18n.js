const translations = {
    es: {
        ...
        hero_description: 'Técnico Superior ASIR especializado en administración de infraestructuras críticas, gestión de identidades y accesos (Microsoft Entra ID, Active Directory), seguridad perimetral y hardening de sistemas. Incorporación inmediata.',
        ...
        edu_asir_level: 'Grado Superior · ASIR (Perfil Ciberseguridad)',
        edu_asir_desc: 'Especialización en infraestructuras de servidores (Linux/Windows), securización de servicios de red, hardening de sistemas, seguridad perimetral y directivas Zero-Trust.',
        edu_smr_title: 'Sistemas Microinformáticos y Redes',
        edu_smr_level: 'Grado Medio · SMR',
        edu_smr_desc: 'Fundamentos de arquitectura hardware, despliegue y clonación de imágenes de sistema, cableado estructurado, direccionamiento IP y soporte técnico en entornos de red local.',
    ...
    ca: {
        ...
        hero_description: 'Tècnic Superior ASIXc especialitzat en administració d\'infraestructures crítiques, gestió d\'identitats i accessos (Microsoft Entra ID, Active Directory), seguretat perimetral i hardening de sistemes. Incorporació immediata.',
        ...
        edu_asir_level: 'Cicle Formatiu de Grau Superior · ASIXc (Perfil Ciberseguretat)',
        edu_asir_desc: 'Especialització en infraestructures de servidors (Linux/Windows), securització de serveis de xarxa, hardening de sistemes, seguretat perimetral i directives Zero-Trust.',
        edu_smr_title: 'Sistemes Microinformàtics i Xarxes',
        edu_smr_level: 'Grau Mitjà · SMX',
        edu_smr_desc: 'Fonaments d\'arquitectura maquinari, desplegament i clonació d\'imatges de sistema, cablejat estructurat, adreçament IP i suport tècnic en entorns de xarxa local.',
    ...
    en: {
        ...
        hero_description: 'ASIR Higher Technician specialized in critical infrastructure administration, identity and access management (Microsoft Entra ID, Active Directory), perimeter security, and system hardening. Immediate availability.',
        ...
        edu_asir_level: 'Higher Vocational Degree · ASIR (Cybersecurity Profile)',
        edu_asir_desc: 'Specialization in server infrastructure (Linux/Windows), network service securitization, system hardening, perimeter security, and Zero-Trust directives.',
        edu_smr_title: 'Microcomputer Systems and Networks',
        edu_smr_level: 'Mid Degree · SMR',
        edu_smr_desc: 'Hardware architecture fundamentals, system image deployment and cloning, structured cabling, IP addressing, and technical support in local network environments.',
        blog_title: 'Blog & Articles',
